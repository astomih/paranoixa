...
Module['FS_createPath']("/", "res", true, true);
    ...
    loadPackage({"files": [{"filename": "/res/compileShader.py", "start": 0, "end": 1940}, {"filename": "/res/run.bat", "start": 1940, "end": 1963}, {"filename": "/res/shader.frag.glsl", "start": 1963, "end": 2412}, {"filename": "/res/shader.frag.spv", "start": 2412, "end": 3296}, {"filename": "/res/shader.frag.wgsl", "start": 3296, "end": 3995}, {"filename": "/res/shader.vert.glsl", "start": 3995, "end": 4283}, {"filename": "/res/shader.vert.spv", "start": 4283, "end": 5443}, {"filename": "/res/shader.vert.wgsl", "start": 5443, "end": 6337}, {"filename": "/res/texture.bmp", "start": 6337, "end": 4911351}], "remote_package_size": 4911351});

  })();

// end include: /tmp/tmpbyuayz3_.js
// include: /tmp/tmpj5u9ksn2.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpj5u9ksn2.js
// include: /tmp/tmpyo4w6guf.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpyo4w6guf.js
...
// end include: preamble.js
  ...
  var _wgpuRenderPassEncoderSetIndexBuffer = (passId, bufferId, format, offset, size) => {
      var pass = WebGPU.mgrRenderPassEncoder.get(passId);
      var buffer = WebGPU.mgrBuffer.get(bufferId);
      if (size == -1) size = undefined;
